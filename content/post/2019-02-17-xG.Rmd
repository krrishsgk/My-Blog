...
half.cor.sp = ggplot(half.cor, aes(xG.total,goal.total)) + geom_point() + geom_smooth(method="lm", se = F)
...
full.cor.sp = ggplot(full.cor, aes(xG.total,goal.total)) + geom_point() + geom_smooth(method="lm", se = F)
#+ labs(x = "foot length (cm)", y = "height (cm)") + geom_smooth(method="lm")
...
week.cor.sp = ggplot(week.cor, aes(xG.total,goal.total)) + geom_point() + geom_smooth(method="lm", se = F)
#+ labs(x = "foot length (cm)", y = "height (cm)") + geom_smooth(method="lm")
...
month.cor.sp = ggplot(month.cor, aes(xG.total,goal.total)) + geom_point() + geom_smooth(method="lm", se = F)
